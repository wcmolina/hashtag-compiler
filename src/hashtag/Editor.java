...
public class Editor extends javax.swing.JFrame {
    ...
    public Editor() {
        ...
        final AttributeSet keyword = cont.addAttribute(cont.getEmptySet(), StyleConstants.Foreground, Color.decode("#54a0ce"));
        ...
        final AttributeSet string = cont.addAttribute(cont.getEmptySet(), StyleConstants.Foreground, Color.decode("#ffaa3e"));
        final AttributeSet function = cont.addAttribute(cont.getEmptySet(), StyleConstants.Foreground, Color.decode("#0b980e"));
    ...
    void setContentChange(boolean b) {
        CONTENT_CHANGED = b;
    }
    ...
    int getColumn(int pos, JTextComponent editor) {
        try {
    ...
    private void openMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openMenuItemActionPerformed
        ...
        if (jf.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            open(jf.getSelectedFile().getPath());
        }
    ...
    private void saveMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveMenuItemActionPerformed
        if (FILE_PATH == null) { //es porque aun no ha abierto un archivo y quiere guardar lo que hay en el textpane...
            ...
            if (CONTENT_CHANGED) { //si hay cambios, entonces
                ...
                Editor.console.setText("No changes have been made");
            }
            ...
            copy.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    if (codeTextPane.getSelectedText() != null) {
                        ...
                        //use this, I was reinventing the wheel...
                        codeTextPane.copy();
                    }
